...
class GameSettingsModel(models.Model):
...
class BonusItemModel(models.Model):
...
class BonusItemLogModel(models.Model):
    bonus_item = models.ForeignKey(BonusItemModel, related_name='bonus_item', on_delete=models.CASCADE)
